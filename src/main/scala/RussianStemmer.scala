...
object RussianStemmer {
  private final val vowels =
    HashSet('а','е','и','о','у','ы','э','ю','€')
  // must follow а или €
  private final val perfectiveGerund1 =
    for (s <- List("вшись","вши","в"); p<-List("а","€")) yield p+s
  ...
  private final val participle1 =
    for (s <- List("щ","ющ","ем","нн","вш"); p<-List("а","€")) yield p+s
  ...
  private final val verb2 =
    List("ила","ыла","ена","ейте","уйте","ите","или","ыли","ей","уй"
      ,"ил","ыл","им","ым","ен","ило","ыло","ено","€т","ует","уют"
      ,"ит","ыт","ены","ить","ыть","ишь","ую","ю")
  private final val noun =
    List( "а","ев","ов","ие","ье","е","и€ми","€ми","ами","еи","ии","и"
      ,"ией","ей","ой","ий","й","и€м","€м","ием","ем","ам","ом"
      ,"о","у","ах","и€х","€х", "ы" ,"ь" ,"ию" ,"ью" ,"ю", "и€"
      ,"ь€" ,"€")
